      ...
      <div className="bg-white rounded-2xl shadow-md p-8 w-full max-w-md space-y-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <Input id="email" type="email" placeholder="admin@aquadelivery.com" {...register('email')} className="mt-1" />
            {errors.email && <p className="text-body-sm text-accent-red mt-1">{errors.email.message}</p>}
          </div>
          ...
          <div>
            ...
            {errors.password && <p className="text-body-sm text-accent-red mt-1">{errors.password.message}</p>}
          </div>
